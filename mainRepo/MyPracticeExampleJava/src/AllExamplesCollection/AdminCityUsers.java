...
public class AdminCityUsers {

    static Map<String, Set<City>> countryDetails = new HashMap<>();
    ...
    private static void printCountryDetails(Map<String, Set<City>> countryDetails) {
        for (Map.Entry<String, Set<City>> entry : countryDetails.entrySet()) {
